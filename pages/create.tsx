...
const Create: NextPage = () => {
  ...
  const { create, loading } = useSubcription({});

  const router = useRouter();

  const { getInputProps, setFieldValue, values } = useForm<
      ...
      <main style={{ padding: 10 }}>
        ...
        <div style={{ padding: 10 }}>
          ...
          <DatePicker
            ...
            onChange={(e) => setFieldValue("firstPayment", dayjs(e))}
          />
          <Group style={{ marginTop: 20 }} noWrap>
            ...
            <NumberInput
              ...
              min={1}
              step={1}
              onChange={(e) => setFieldValue("recurrenceCount", !e ? 1 : e)}
            ...
            <Select
              ...
              onChange={(e) =>
                setFieldValue(
                  "recurrenceType",
                  e as "year" | "month" | "day" | "hour" | "minute" | "second"
                )
              }
              data={[
                { value: "year", label: "An" },
          ...
          <Group position="right" style={{ marginTop: 20 }}>
            <Button variant="light" loading={loading} onClick={handleCreate}>
              Créer
            </Button>
          </Group>
        </div>
